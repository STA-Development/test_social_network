	...
	return (
		<header className="bg-hardBlue border-b-2 border-orange text-gray relative z-10">
			<nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
				...
				<Popover.Group className="hidden lg:flex lg:gap-x-12">
					<div className='transition duration-200 ease-in hover:text-orange'>
						<Link to="/Readers" className="hover:underline-offset-3 decoration-hardBlue text-sm font-semibold leading-6 text-gray-900 ">
							Readers
						</Link>
					</div>
					<div className='transition duration-200 ease-in hover:text-orange'>
            ...
            <div className='flex items-center' >
            	<Link to="/signIn" className="text-sm font-semibold leading-6 text-gray-900 mr-3">Sign in</Link>
            	<div className='w-10 h-10 rounded-full'></div>
					...
					{user &&
						<>
							...
							<Link to='/Profile' ><img src={user.picture? user.picture: ''} className='w-10 h-10 rounded-full' alt=""/></Link>
						</>
					}
				</div>
			</nav>
