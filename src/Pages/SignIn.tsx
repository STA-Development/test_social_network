...
const SignIn = () => {
	...
	const handleSignIn = async (e:React.FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			console.log(e);
			setLoading(false);
			ToastNotifyError('something is wrong check if email/password are correct 🤖');
		}
	};
						...
						<div className='mt-5 flex flex-col justify-center items-center'>
							<div className='mt-6'>
								<p className='text-center text-gray-dark'>
                                    Not signed up yet?  <Link to='/signUp' className='text-orange hover:text-hardBlue transition duration-200 ease-in'>Go and sign UP!</Link>
								</p>
							</div>
						</div>
					</div>
